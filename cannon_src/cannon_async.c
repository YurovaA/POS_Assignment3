...
int main (int argc, char **argv) {
	...
	double *A_local_block = NULL, *A_local_block_new = NULL, *B_local_block = NULL,  *B_local_block_new = NULL, *C_local_block = NULL, start_overall, time_overall;
	...
	for(cannon_block_cycle = 0; cannon_block_cycle < sqrt_size; cannon_block_cycle++){
		...
		B_local_block_new = B_local_block;
	...
	free(B_local_block);
	free(C_local_block);
	//time_overall = MPI_Wtime() - start_overall;
