...
int main (int argc, char **argv) {
	...
	/*if (rank == 7){
		...
		printf("Local matrices!\n");
		for(row = 0; row < A_local_block_rows; row++) {
				for(column = 0; column < A_local_block_columns; column++)
					printf ("%7.3f ", A_local_block[row * A_local_block_columns + column]);
				printf ("\n");
			}
		for(row = 0; row < B_local_block_rows; row++) {
				for(column = 0; column < B_local_block_columns; column++)
					printf ("%7.3f ", B_local_block[row * B_local_block_columns + column]);
				printf ("\n");
			}
	}*/
	//if (rank == 0) printf("Reached Cannon!");
	for(cannon_block_cycle = 0; cannon_block_cycle < sqrt_size; cannon_block_cycle++){
		// compute partial result for this block cycle
		/*if (rank == 7){
		printf("Iteration number: %7.3f\n", cannon_block_cycle);
		int i, j, k, row, column;
		printf("Local matrices!\n");
		for(row = 0; row < A_local_block_rows; row++) {
				for(column = 0; column < A_local_block_columns; column++)
		...
		for(row = 0; row < A_local_block_rows; row++) {
				for(column = 0; column < B_local_block_columns; column++)
					printf ("%7.3f ", C_local_block[row * B_local_block_columns + column]);
				printf ("\n");
			}*/
	//}
